...
var sound_effects: SoundEffectsPlayer = SoundEffectsPlayer.new(["Sounds", "Sfx", "SFX"], 8)
var ui_sound_effects: SoundEffectsPlayer = SoundEffectsPlayer.new(["UI", "Ui", "Interface", "Sounds", "SFX"], 8)
