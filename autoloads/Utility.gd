...
## it search for a signal in the node provided, strips their arguments, and connects them to the callable provided
func connect_signal(
	## The signal to search
	signal_name: StringName,
	## The node to search the signal for 
	node_with_signals: Node,
	## The callable to connect the signal to
